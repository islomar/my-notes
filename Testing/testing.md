...
- _Deterministic tests_: do not use the constants from business code in the tests.
- _Folder structure_: the tests should mimic the same folder structure than the business code.
